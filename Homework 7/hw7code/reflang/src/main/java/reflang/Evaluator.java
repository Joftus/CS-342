...
public class Evaluator implements Visitor<Value> {
  ...
  @Override
	...
	public Value visit(RefExp e, Env env) {
		return heap.ref((Value) e.value().accept(this, env));
	}

	@Override
	public Value visit(DerefExp e, Env env) {
		return heap.deref((RefVal) e._loc.accept(this, env));
	}

	@Override
	public Value visit(AssignExp e, Env env) {
		if (e.loc().accept(this, env) instanceof NumVal)
			return heap.setref((NumVal) e._loc.accept(this, env), (Value) e._value.accept(this, env));
		else return heap.setref((RefVal) e._loc.accept(this, env), (Value) e._value.accept(this, env));
	}

	@Override
	public Value visit(FreeExp e, Env env) {
		heap.free((RefVal) e._loc.accept(this, env));
		return new UnitVal();
	}
