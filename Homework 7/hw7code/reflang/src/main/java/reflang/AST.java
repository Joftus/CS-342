...
public interface AST {
	...
	public static class RefExp extends Exp {
		Exp _value;
		public RefExp(Exp value) { this._value = value; }
		public Exp value() { return _value; }
		public Object accept(Visitor visitor, Env env) {
			return visitor.visit(this, env);
		}
	}
	...
	public static class DerefExp extends Exp {
		Exp _loc;
		public DerefExp(Exp loc) { this._loc = loc; }
	...
	public static class AssignExp extends Exp {
		Exp _value;
		Exp _loc;
		public AssignExp(Exp loc, Exp value) {
			this._value = value;
			this._loc = loc;
		}
		public Exp value() { return _value; }
	...
	public static class FreeExp extends Exp {
		Exp _loc;
		public FreeExp(Exp loc) { this._loc = loc; }
		public Exp loc() { return _loc; }
		public Object accept(Visitor visitor, Env env) {
			return visitor.visit(this, env);
		}
